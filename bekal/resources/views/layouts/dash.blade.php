        ...
        <div class="center-container">
            <div class="container">
                <div class="banner_top">
                    <div class="col-md-12 col-sm-8 col-xs-8 w3_menu">
                        @if (Auth::guest())
                        ...
                        @else
                            <div class="col-md-12 col-sm-4 col-xs-4 top-nav-text">
                                ...
                                <a style="padding-left: 25px" class="page-scroll" href="{{ url('/showProfilAnak') }}" data-toggle="modal" data-hover="LOGIN">PROFIL ANAK</a>
                                <a style="padding-left: 25px" class="page-scroll" href="{{ url('/menu') }}" data-toggle="modal" data-hover="LOGIN">PESAN</a>
                                <a style="padding-left: 25px" class="page-scroll" href="{{ url('/histoKonsul') }}" data-toggle="modal" data-hover="LOGIN">KONSULTASI</a>
