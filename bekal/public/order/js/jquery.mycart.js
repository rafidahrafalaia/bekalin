  ...
  var loadMyCartEvent = function(targetSelector){
    ...
    if(!$("#" + idCartModal).length) {
      $('body').append(
        ...
        '<button type="button" class="btn btn-default ' + classCheckoutCart + ' " data-dismiss="modal" style="background-color: #2869d3; color:white; " >Checkout</button>' +
        '</div>' +
        '</div>' +
        '</div>' +
        '</div>'
    ...
    var drawTable = function(){
      ...
      $.each(products, function(){
        ...
        $cartTable.append(
          ...
          '<td><select id="inputState" class="form-control"><option>Nafingatun Ngaliah</option><option>Astrid Febrianca</option><option>Syavira Tiara Z</option><option>Sirria Panah Alam</option></select></td>' +
          // '<td title="Anak"><option type="number" style="width: 70px;" value="' + this.anak + '"/></option></td>' +
          '<td title="Unit Price">' + options.currencySymbol + MathHelper.getRoundedNumber(this.price) + '</td>' +
          '<td title="Remove from Cart" class="text-center" style="width: 20px;" type="button"><a href="javascript:void(0);" class=" btn btn-default ' + classProductRemove + '" style="background-color: #ff0f0f; color: white;">x</a></td>' +
          '</tr>'
        );
      });
